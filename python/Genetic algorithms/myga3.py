...
class MyGA3:
    ...
    def mutate(self, population):
        # Problem specific.
        # There are 4 individuals in the population. Each is 5-bits-long binary string. So, in total, there are 20 bits.
        probNoMutations = (1-self.mutProb)**20 # Case specific '20'
